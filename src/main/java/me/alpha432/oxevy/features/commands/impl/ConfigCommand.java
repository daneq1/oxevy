...
public class ConfigCommand extends Command {
    ...
    public void createArgumentBuilder(LiteralArgumentBuilder<CommandManager> builder) {
        ...
        builder.then(literal("save").then(argument("name", word()).executes(context -> {
        ...
        builder.then(literal("load").then(argument("name", word()).executes(context -> {
            String name = getString(context, "name");
        ...
        builder.then(literal("delete").then(argument("name", word()).executes(context -> {
            String name = getString(context, "name");
